...
class TestKernelBenchmarks:
    ...
    def test_local_matrix(self, benchmark, size):
        wave = torch.DoubleTensor(np.linspace(1e4, 2e4, size))
        amp = 100
        mu = 1.5e4
        sigma = 1e3
